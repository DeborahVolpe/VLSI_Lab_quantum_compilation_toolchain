...
originalCircuitsFolder = "qasm/original" # Path to the folder containing the .qasm files to route.
routedCircuitsFolder = "qasm/routed/M/HA algorithm" # Path to the folder in which to store the routed circuits.
