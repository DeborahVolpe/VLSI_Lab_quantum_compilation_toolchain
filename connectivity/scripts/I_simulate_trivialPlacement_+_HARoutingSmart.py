...
# Circuit:
qasmFile = "./qasms/rebased/github/I/large/0410184_169.qasm"
...
routedCircuit, finalMapping = router.routeHardwareAwareRoutingSmart(circuit, trivialMapping, 50, 0.5, 0.0, 0.5, 0.5, 
                                                                    False)
