...
u1(-10.0800000000000)  q[7];
u1(2.24000000000000)  q[9];
cx q[12], q[15];
u1(-1.00000000000000)  q[14];
u2(0,pi)  q[2];
u2(0,pi)  q[3];
u1(2.10000000000000)  q[1];
...
u1(0.0)  q[2];
u1(0.0)  q[3];
u1(-8.40000000000000)  q[1];
cx q[12], q[15];
cx q[4], q[7];
u1(-1.12000000000000)  q[9];
u1(-1.00000000000000)  q[11];
u1(-1.00000000000000)  q[14];
...
u1(2.70000000000000)  q[4];
u1(-3.24000000000000)  q[1];
u1(-1.00000000000000)  q[10];
u1(-1.00000000000000)  q[13];
u1(-1.00000000000000)  q[12];
u2(0,pi)  q[15];
