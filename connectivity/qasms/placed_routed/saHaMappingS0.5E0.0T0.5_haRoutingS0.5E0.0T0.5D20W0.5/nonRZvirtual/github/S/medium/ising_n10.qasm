...
cx q[1], q[0];
u2(0,pi)  q[5];
u1(-0.900000000000000)  q[11];
swap q[2], q[1];
u1(-0.260000000000000)  q[0];
cx q[4], q[1];
u1(-0.260000000000000)  q[2];
u1(-0.380000000000000)  q[4];
...
cx q[7], q[6];
cx q[1], q[0];
u1(0.660000000000000)  q[2];
u1(0.780000000000000)  q[3];
u2(0,pi)  q[5];
u1(-0.144000000000000)  q[11];
cx q[4], q[7];
u1(-1.08000000000000)  q[0];
u1(-0.360000000000000)  q[6];
u1(0.780000000000000)  q[3];
u1(-0.960000000000000)  q[5];
u1(-1.50000000000000)  q[11];
cx q[1], q[0];
cx q[7], q[6];
u2(0,pi)  q[5];
cx q[4], q[7];
