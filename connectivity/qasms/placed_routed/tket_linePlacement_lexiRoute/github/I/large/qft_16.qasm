...
rx(1.0*pi) q[6];
cx q[16],q[11];
rz(3.183098861837907e-05*pi) q[15];
cx q[0],q[11];
...
cx q[6],q[7];
cx q[15],q[13];
rz(6.366197723675813e-05*pi) q[16];
...
cx q[16],q[12];
rz(1.5915494309189534e-05*pi) q[15];
cx q[0],q[12];
...
rx(1.0*pi) q[7];
rx(1.0*pi) q[15];
rz(3.183098861837907e-05*pi) q[16];
measure q[15] -> c[0];
