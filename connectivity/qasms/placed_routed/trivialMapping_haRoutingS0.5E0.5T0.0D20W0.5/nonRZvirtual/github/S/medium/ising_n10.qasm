...
cx q[6], q[7];
u1(1.54000000000000)  q[4];
u1(-2.10000000000000)  q[5];
u1(-1.82000000000000)  q[8];
u1(-1.82000000000000)  q[9];
u1(0.912000000000000)  q[0];
swap q[7], q[4];
cx q[3], q[5];
u1(-1.82000000000000)  q[8];
