...
cx q[10], q[12];
swap q[5], q[3];
u1(-0.780000000000000)  q[13];
swap q[4], q[1];
cx q[2], q[3];
u1(0.780000000000000)  q[5];
u1(-1.14000000000000)  q[10];
cx q[13], q[14];
cx q[0], q[1];
...
u1(0.0)  q[8];
cx q[10], q[12];
u1(-1.30000000000000)  q[13];
swap q[1], q[2];
swap q[5], q[3];
u1(-0.560000000000000)  q[8];
u1(-1.90000000000000)  q[10];
swap q[4], q[1];
cx q[2], q[3];
...
cx q[2], q[3];
cx q[10], q[12];
u1(-1.82000000000000)  q[13];
u1(-0.720000000000000)  q[8];
cx q[1], q[2];
u1(-2.66000000000000)  q[10];
cx q[13], q[14];
u1(-0.720000000000000)  q[8];
cx q[2], q[3];
u1(-2.66000000000000)  q[10];
...
cx q[2], q[3];
cx q[10], q[12];
u1(-2.34000000000000)  q[13];
u1(-3.24000000000000)  q[3];
u1(-3.42000000000000)  q[10];
swap q[1], q[2];
cx q[13], q[14];
swap q[4], q[1];
cx q[3], q[2];
