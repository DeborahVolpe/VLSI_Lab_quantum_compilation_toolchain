...
u3(pi/2,pi,0) q[25];
cx q[24],q[25];
u3(1.3050066,-pi/2,pi/2) q[24];
u3(pi/2,0,0) q[25];
cx q[25],q[24];
u3(-pi/2,-pi/2,pi/2) q[25];
u1(pi/2) q[25];
cx q[24],q[25];
u3(pi/2,2.8758029,pi) q[24];
u1(-2.8758029) q[24];
u3(pi/2,0,0) q[24];
u3(pi/2,-pi/2,pi/2) q[24];
u3(pi/2,2.8758029,0) q[25];
u1(-2.8758029) q[25];
u3(pi/2,0,0) q[25];
u3(pi/2,-pi/2,pi/2) q[25];
u2(0,pi) q[26];
...
u1(0.4672733) q[24];
u3(pi/2,0,5.6591587) q[24];
u3(pi/2,-pi/2,pi/2) q[24];
u3(pi/2,2.8758029,0) q[26];
u1(-2.8758029) q[26];
u3(pi/2,pi,0) q[26];
cx q[25],q[26];
u3(1.3050066,-pi/2,pi/2) q[25];
u3(pi/2,0,0) q[26];
cx q[26],q[25];
u3(-pi/2,-pi/2,pi/2) q[26];
u1(pi/2) q[26];
cx q[25],q[26];
u3(pi/2,2.8758029,pi) q[25];
u1(-2.8758029) q[25];
u3(pi/2,0,0) q[25];
u3(pi/2,-pi/2,pi/2) q[25];
cx q[25],q[23];
...
u3(pi/2,pi,0) q[23];
u3(pi/2,2.8758029,pi) q[25];
u3(-1.985717,-pi/2,pi/2) q[25];
u1(0.4672733) q[25];
u3(pi/2,pi,5.6591587) q[25];
cx q[24],q[25];
u3(1.103523,-pi/2,pi/2) q[24];
u3(pi/2,0,0) q[25];
cx q[25],q[24];
u3(-pi/2,-pi/2,pi/2) q[25];
u1(pi/2) q[25];
cx q[24],q[25];
u3(pi/2,3.2983459,pi) q[24];
u1(0.4672733) q[24];
u3(pi/2,0,5.6591587) q[24];
u3(pi/2,-pi/2,pi/2) q[24];
u3(pi/2,3.2983459,0) q[25];
u1(0.4672733) q[25];
u3(pi/2,0,5.6591587) q[25];
u3(pi/2,-pi/2,pi/2) q[25];
u3(pi/2,2.8758029,0) q[26];
u1(-2.8758029) q[26];
u3(pi/2,0,0) q[26];
...
u3(pi/2,2.8758029,pi) q[26];
u3(-1.985717,-pi/2,pi/2) q[26];
u1(0.4672733) q[26];
u3(pi/2,pi,5.6591587) q[26];
cx q[24],q[26];
u3(1.103523,-pi/2,pi/2) q[24];
u3(pi/2,0,0) q[26];
cx q[26],q[24];
...
u3(pi/2,3.2983459,0) q[26];
u1(0.4672733) q[26];
u3(pi/2,0,5.6591587) q[26];
u3(pi/2,-pi/2,pi/2) q[26];
cx q[26],q[18];
u3(pi/2,0,0) q[18];
u3(1.103523,-pi/2,pi/2) q[26];
cx q[18],q[26];
u3(-pi/2,-pi/2,pi/2) q[18];
u1(pi/2) q[18];
cx q[26],q[18];
...
u3(pi/2,3.2983459,pi) q[26];
u3(-2.108036,-pi/2,pi/2) q[26];
measure q[24] -> c[0];
measure q[25] -> c[1];
measure q[26] -> c[2];
measure q[23] -> c[3];
